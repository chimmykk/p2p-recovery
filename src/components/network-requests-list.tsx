...
export function NetworkRequestsList() {
  ...
  if (error) {
    return (
      <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg sm:rounded-xl p-6 sm:p-8 shadow-soft" suppressHydrationWarning>
        <div className="flex items-start sm:items-center gap-2 sm:gap-3 text-error-dark dark:text-error-light">
    ...
    <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 shadow-soft" suppressHydrationWarning>
      ...
      {requests.length === 0 ? (
        <div className="text-center py-8 sm:py-10 md:py-12">
          <div className="w-14 h-14 sm:w-16 sm:h-16 bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
      ...
      {/* Refresh Info */}
      <div className="mt-4 sm:mt-5 md:mt-6 p-2.5 sm:p-3 bg-info-light dark:bg-info-dark/20 border border-info/20 rounded-lg">
